...
enum Color_2D{
	...
	BRIGHT_RED_1,			//238,20,45
	BRIGHT_RED_2,			//229 52 165
	BRIGHT_RED_3,			//231 15 62
	BRIGHT_RED_4,			//246 122 218
	BRIGHT_RED_5,			//238 5 33
	BRIGHT_RED_6,			//243 58 60

	BRIGHT_YELLOW_1,		// 235 249,81
	BRIGHT_YELLOW_2,		//244,229,109
	BRIGHT_YELLOW_3,		//244 213 28
	BRIGHT_YELLOW_4,		//253 218 76
	BRIGHT_YELLOW_5,		//228,234,92
	BRIGHT_YELLOW_6,		//234,228,106

	BRIGHT_ORANGE_1,		//241 132 18
	BRIGHT_ORANGE_2,		//244 129 83

	BRIGHT_GREEN_1,		//10  115 225 121
	BRIGHT_GREEN_2,		// 102 250 82
	BRIGHT_GREEN_3,		//177,244,83
	BRIGHT_GREEN_4,		//117 226 153
	BRIGHT_GREEN_5,		//7, 226, 129
	BRIGHT_GREEN_6,		//111,226,120
	BRIGHT_GREEN_7,		//90,254,108
	BRIGHT_GREEN_8,		//111 226 120
	BRIGHT_GREEN_9,		//163 255 118

	BRIGHT_BLUE_1,		//11 33 201 216
	BRIGHT_BLUE_2,		//77,94,209
	BRIGHT_BLUE_4,		//84 216 177
	BRIGHT_BLUE_3,	//30,168,194
...
public:
	...
	void Set(int x, int y, int size = 10)
	{
		Mouse::x = x;
		this->y = y;
		Mouse::size = size;
...
public:
	...
	void static drawText(HDC hdc, int x, int y, COLORREF rgb, int size, TCHAR _font[], TCHAR *_message, ...)
	{
		TCHAR message[80];
		HFONT hFont, OldFont;
	...
	*/
	...
	MoveToEx(hdc, x - size + size * 2, y - size, NULL);
	LineTo(hdc, x - size + size * 2, y - size + size * 2);


	MoveToEx(hdc, x - size + size * 2, y - size + size * 2, NULL);
	LineTo(hdc, x - size, y - size + size * 2);


	MoveToEx(hdc, x - size, y - size + size * 2, NULL);
	LineTo(hdc, x - size, y - size);
	...
	*/
	...
	static int getRGB(int RGB, int num){
		int rgb[3] = { 0 };
		if (RGB == RANDOM)RGB = rand() % (WHITE - 1);
		switch (RGB){
		case RED:
		...
		case BRIGHT_ORANGE_1:
			rgb[0] = 241; rgb[1] = 132; rgb[2] = 18;
			break;
		case BRIGHT_ORANGE_2:
		...
		case RANDOBJECT_COLOR:
			rgb[0] = 0; rgb[1] = 162; rgb[2] = 232;
			break;

		case REMOVE_STONEBALL:
